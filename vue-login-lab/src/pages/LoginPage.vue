<template>
  <div class="login-container">
    ...
    <div class="top-bar">
      <center>
        <div class="logo">
          <img src="@/assets/Wishlist.png" alt="Area" class="img-fluid justify-content-center" />
        </div>
      </center>
    </div>
...
<style scoped>
/* Make entire page olive green */
body {
  background-color: #3E513E !important; /* Olive green sides */
  margin: 0;
  padding: 0;
  overflow-x: hidden;
}
...
/* Main container */
.login-container {
  background-color: #3E513E; /* Outer olive background */
  min-height: 100vh;
  display: flex;
...
/* General Layout */
.login-container {
  background-color: #3E513E; /* Olive green outer background */
  min-height: 100vh;
  display: flex;
  flex-direction: column;
  font-family: 'Inter', sans-serif;
...
/* Wrapper with rounded white area */
.login-wrapper {
